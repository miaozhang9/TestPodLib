...
- (void)promptLabelText:(OCFTFaceDetectOptimizationType)promptLabelStr{
    ...
    switch (promptLabelStr) {
        ...
        case OCFT_TOO_FUZZY:
            ...
            break;
        case OCFT_TOO_LEFT:
            promptLabel.text = @"过于偏左，请正对摄像头";
            break;
        case OCFT_TOO_RIGHT:
            promptLabel.text = @"过于偏右，请正对摄像头";
            break;
        case OCFT_TOO_UP:
            promptLabel.text = @"过于偏上，请正对摄像头";
            break;
        case OCFT_TOO_DOWN:
            promptLabel.text = @"过于偏下，请正对摄像头";
            break;
        case OCFT_MULTIPLE_FACE:
            promptLabel.text = @"采集框存在多人";
            break;
        case OCFT_EYES_CLOSED:
            promptLabel.text = @"请保持眼睛睁开";
            break;
        case OCFT_NORMAL:
