cordova.define("qhCordova-plugin-basicMessage.basicMessage", function(require, exports, module) {
    ...
    module.exports = {
        ...
        getDeviceInfo: function(successCallback, errorCallback, isShowContact) {
               exec(successCallback, errorCallback, "QHBasicMessagePlugin", "getDeviceInfo", [isShowContact]);
        },
        ...
        getDataInfo: function(successCallback, errorCallback) {
               exec(successCallback, errorCallback, "QHBasicMessagePlugin", "getDataInfo", []);
        },
       executeH5InfoAction: function(params, successCallback, errorCallback) {
       //       if (typeof params === 'object') {
               exec(successCallback, errorCallback, "QHBasicMessagePlugin", "executeH5InfoAction", [params]);
       //        }
       },
